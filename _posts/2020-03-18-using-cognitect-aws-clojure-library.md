...
![](/img/2020-03-18-using-cognitect-aws-clojure-library_img_2.png)Timing the tests.… and from Finland hitting the real AWS DynamoDB located in Ireland: **0m42.796s** => takes about 4 times longer to run all tests.
